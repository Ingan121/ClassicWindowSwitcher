...
#define SWS_WINDOWSWITCHER_FLASH_COLOR RGB(255, 114, 0)
inline RGBQUAD sws_GetFlashRGB(BOOL bIsDarkMode)
{
    double alpha = 0.9;
    RGBQUAD rgbFlash = {
        GetBValue(SWS_WINDOWSWITCHER_FLASH_COLOR) * alpha,
        GetGValue(SWS_WINDOWSWITCHER_FLASH_COLOR) * alpha,
        GetRValue(SWS_WINDOWSWITCHER_FLASH_COLOR) * alpha,
        alpha * 255
    };
    return rgbFlash;
}
...
#define SWS_WINDOWSWITCHERLAYOUT_ROWHEIGHT 43
#define SWS_WINDOWSWITCHERLAYOUT_MAX_TILE_WIDTH 2.0

#define SWS_WINDOWSWITCHERLAYOUT_ITEMSIZE 43

#define SWS_WINDOWSWITCHERLAYOUT_MASTER_PADDING_TOP 16
#define SWS_WINDOWSWITCHERLAYOUT_MASTER_PADDING_LEFT 13
#define SWS_WINDOWSWITCHERLAYOUT_MASTER_PADDING_BOTTOM 16
#define SWS_WINDOWSWITCHERLAYOUT_MASTER_PADDING_RIGHT 17

#define SWS_WINDOWSWITCHERLAYOUT_ELEMENT_PADDING_TOP 0
#define SWS_WINDOWSWITCHERLAYOUT_ELEMENT_PADDING_LEFT 0
#define SWS_WINDOWSWITCHERLAYOUT_ELEMENT_PADDING_BOTTOM 0
#define SWS_WINDOWSWITCHERLAYOUT_ELEMENT_PADDING_RIGHT 0

#define SWS_WINDOWSWITCHERLAYOUT_PADDING_TOP 0
...
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAIL_WIDTH 39
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAIL_HEIGHT 39
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_TITLECOLOR RGB(153, 153, 153)
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_GRADIENT_UP RGB(255, 255, 255)
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_GRADIENT_DOWN SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_TITLECOLOR
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAILPADDING_TOP 1
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAILPADDING_LEFT 7
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAILPADDING_BOTTOM SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAILPADDING_LEFT
#define SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAILPADDING_RIGHT SWS_WINDOWSWITCHERLAYOUT_EMPTYWINDOW_THUMBNAILPADDING_LEFT

#define SWS_WINDOWSWITCHERLAYOUT_THUMBNAIL_MINWIDTH 39
#define SWS_WINDOWSWITCHERLAYOUT_THUMBNAIL_MINHEIGHT 0
